        ...
        <>
            ...
            <footer>
                <div className="Fashions">
                    <div>
                        <span className="Heading">ONLINE SHOPPING</span>
                    ...
                    <div>
                        <span className="Heading">EXPERIENCE MYNTRA APP ON MOBI</span>
                        <div style={{ display: "flex", paddingTop: "30px", paddingLeft: "0px" }}>
                            <div>
                                <img className=" Googleimage" src="https://constant.myntassets.com/web/assets/img/80cc455a-92d2-4b5c-a038-7da0d92af33f1539674178924-google_play.png"></img>
                            </div>
                            <div>
                                <img className="Googleimage2" src="https://constant.myntassets.com/web/assets/img/bc5e11ad-0250-420a-ac71-115a57ca35d51539674178941-apple_store.png"></img>
                            </div>
                        </div>
                        <div style={{ paddingTop: "30px" }}>
                            <span className="Heading">KEEP IN TOUCH</span>
                            <div style={{ paddingTop: "20px", paddingLeft: "-10px" }}>
                                <img className="Icons" src="https://constant.myntassets.com/web/assets/img/f10bc513-c5a4-490c-9a9c-eb7a3cc8252b1574604275383-twitter.png"></img>
                                <img className="Icons" src="https://constant.myntassets.com/web/assets/img/d2bec182-bef5-4fab-ade0-034d21ec82e31574604275433-fb.png"></img>
                                <img className="Icons" src="https://constant.myntassets.com/web/assets/img/a7e3c86e-566a-44a6-a733-179389dd87111574604275355-yt.png"></img>
                                <img className="Icons" src="https://constant.myntassets.com/web/assets/img/b4fcca19-5fc1-4199-93ca-4cae3210ef7f1574604275408-insta.png"></img>
                            </div>
                        </div>
                    </div>

                    <div style={{ paddingLeft: "0px" }}>
                        <img className="Icons2" src="https://constant.myntassets.com/web/assets/img/6c3306ca-1efa-4a27-8769-3b69d16948741574602902452-original.png"></img>
                        <p> <span>100% ORIGINAL guarantee</span> for all products at myntra.com</p>
                        <img className="Icons2" src="https://assets.myntassets.com/assets/images/retaillabs/2023/5/22/becb1b16-86cc-4e78-bdc7-7801c17947831684737106127-Return-Window-image.png"></img>
